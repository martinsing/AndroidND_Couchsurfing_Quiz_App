...
public class Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.question_3);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (response == 0) {
                    ...
                    q3 = 1;
                    Toast.makeText(getApplicationContext(), R.string.right_answer_3, Toast.LENGTH_SHORT).show();
                } else {
                    q3 = 0;
                    Toast.makeText(getApplicationContext(), R.string.wrong_answer_3, Toast.LENGTH_SHORT).show();
                }
